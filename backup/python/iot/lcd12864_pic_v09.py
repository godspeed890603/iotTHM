...
def readS1(lcd):
    ...
    if (temperature1  is not None and humidity1 is not None
        and temperature1<VALUE_TEMPERATURE_MAX and temperature1>VALUE_TEMPERATURE_MIN
        and humidity1<VALUE_HUMIDITY_MAX and humidity1>VALUE_HUMIDITY_MIN):
...
def readS2(lcd):
    ...
    if (temperature2  is not None and humidity2 is not None 
        and  temperature2<VALUE_TEMPERATURE_MAX and temperature2>VALUE_TEMPERATURE_MIN
        and humidity2<VALUE_HUMIDITY_MAX and humidity2>VALUE_HUMIDITY_MIN):
